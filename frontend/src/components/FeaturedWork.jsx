          ...
          {featuredWork.map((work, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-white tracking-tight" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
                  {work.title}
                </h3>
                ...
                <div className="flex items-center gap-2 text-amber-500 mt-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200">
